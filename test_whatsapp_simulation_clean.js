// WhatsApp Simulation Script - Clean Version
// Runs from webhook folder, uses test files from tests folder
...
// Test files to process (relative to tests folder)
const testFiles = [
      ...
      try {
        ...
        if (sheetsResult) {
          ...
          const successMessage = `🎉 ${filename} succesvol verwerkt!\n\n📊 Factuurnummer: ${invoiceNumber}\n🏢 Bedrijf: ${
            ...
            analysisResult.analysis?.financial_info?.date || "Onbekend"
